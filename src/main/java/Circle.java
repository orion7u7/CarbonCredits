...
public class Circle extends Shape {
    ...
    public Circle(int centerX, int centerY, int radius, Color color, String figureType, String areaType) {
        super(centerX - radius, centerY - radius, 2 * radius, 2 * radius, color, figureType, areaType);
        this.radius = radius;
    }
